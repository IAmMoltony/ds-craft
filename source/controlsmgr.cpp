...
{
    mtnlogMessageTag(MTNLOG_INFO, "controlsmgr", "Loading controls");
...
{
    mtnlogMessageTag(MTNLOG_INFO, "controlsmgr", "Saving controls");
...
{
    mtnlogMessageTag(MTNLOG_INFO, "controlsmgr", "Writing default controls");
...
{
    mtnlogMessageTag(MTNLOG_INFO, "controlsmgr", "Setting button %u to key %u", button, key);
