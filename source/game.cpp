...
void Game::init(int argc, char **argv)
{
    ...
    {
        mtnlogMessageTagC(MTNLOG_ERROR, "init", "Error initializing filesystem");
    ...
    mtnlogMessageTagC(MTNLOG_INFO, "init", "%d arguments", argc);
    for (int i = 0; i < argc; ++i)
        mtnlogMessageTagC(MTNLOG_INFO, "init", "Argument %d: %s", i, argv[i]);

    mtnlogMessageTagC(MTNLOG_INFO, "init", "Initializing sound");
    ...
    mtnlogMessageTagC(MTNLOG_INFO, "init", "Loading settings");
    ...
    mtnlogMessageTagC(MTNLOG_INFO, "init", "Loading controls");
    ...
    case State::WorldSelect:
        ...
        else if ((down & KEY_X) || (down & KEY_START))
        {
            if (!worldSelectWorlds.empty())
            {
                ...
                {
                    mtnlogMessageTagC(MTNLOG_ERROR, "worldselect", "Failed getting world version for world %s", worldName.c_str());
                    return;
                }
